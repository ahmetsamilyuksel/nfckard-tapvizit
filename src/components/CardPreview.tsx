...
export default function CardPreview({ card, t, onPhotoClick, fullScreen = false }: Props) {
  ...
  // Modern width with comfortable padding - wider cards with margins
  const containerClass = fullScreen ? "max-w-md mx-auto" : "max-w-md mx-auto";
...
function ModernLayout({ card, t, initials, onPhotoClick, textPrimaryColor, textSecondaryColor, containerClass = "max-w-md mx-auto" }: LayoutProps) {
...
function SidebarLayout({ card, t, bgStyle, bgClass, initials, onPhotoClick, textPrimaryColor, textSecondaryColor, containerClass = "max-w-md mx-auto" }: LayoutProps) {
  const finalBgStyle = card.backgroundColor
    ? { background: createRadialGradient(card.backgroundColor, card.gradientIntensity || 50) }
    : bgStyle;
...
function MinimalLayout({ card, t, bgStyle, bgClass, initials, onPhotoClick, textPrimaryColor, textSecondaryColor, containerClass = "max-w-md mx-auto" }: LayoutProps) {
  const finalBgStyle = card.backgroundColor
    ? { background: createRadialGradient(card.backgroundColor, card.gradientIntensity || 50) }
    : bgStyle;
...
function BoldLayout({ card, t, initials, onPhotoClick, textPrimaryColor, textSecondaryColor, containerClass = "max-w-md mx-auto" }: LayoutProps) {
  const bgColor = card.backgroundColor || "#ffffff";
  const bgGradient = createRadialGradient(bgColor, card.gradientIntensity || 50);
...
function StylishLayout({ card, t, initials, onPhotoClick, textSecondaryColor, containerClass = "max-w-md mx-auto" }: LayoutProps) {
  const bgColor = card.backgroundColor || "#ffffff";
  const bgGradient = createRadialGradient(bgColor, card.gradientIntensity || 50);
...
function ElegantLayout({ card, t, initials, onPhotoClick, textPrimaryColor, textSecondaryColor, containerClass = "max-w-md mx-auto" }: LayoutProps) {
  const bgColor = card.backgroundColor || "#ffffff";
  const bgGradient = createRadialGradient(bgColor, card.gradientIntensity || 50);
...
function CreativeLayout({ card, t, initials, onPhotoClick, textPrimaryColor, textSecondaryColor, containerClass = "max-w-md mx-auto" }: LayoutProps) {
  const bgColor = card.backgroundColor || "#ffffff";
  const bgGradient = createRadialGradient(bgColor, card.gradientIntensity || 50);
