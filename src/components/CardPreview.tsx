...
function VKontakteIcon() {
  return (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="#0077FF">
    ...
    <svg className="w-4 h-4" viewBox="0 0 24 24">
      <defs>
        <linearGradient id="tiktok-gradient" x1="0%" y1="0%" x2="100%" y2="100%">
          ...
          <stop offset="50%" style={{stopColor: '#FE2C55'}} />
...
function WeChatIcon() {
  return (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="#09B83E">
...
function VKMaxIcon() {
  return (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="#FF6F00">
...
function WildberriesIcon() {
  return (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="#EC238D">
      <path d="M3.6 3.6l4.8 8.4L3.6 20.4h2.4l3.6-6.3 3.6 6.3h2.4l-4.8-8.4 4.8-8.4h-2.4L9.6 9.9 6 3.6H3.6zm14.4 0v16.8h2.4V3.6h-2.4z"/>
    </svg>
  );
}
...
function OzonIcon() {
  return (
    <svg className="w-4 h-4" viewBox="0 0 24 24" fill="#005BFF">
      <path d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2zm0 18c-4.411 0-8-3.589-8-8s3.589-8 8-8 8 3.589 8 8-3.589 8-8 8z"/>
      <path fill="#005BFF" d="M12 7c-2.761 0-5 2.239-5 5s2.239 5 5 5 5-2.239 5-5-2.239-5-5-5zm0 8c-1.654 0-3-1.346-3-3s1.346-3 3-3 3 1.346 3 3-1.346 3-3 3z"/>
    </svg>
  );
}
...
function YandexMarketIcon() {
  return (
    <svg className="w-4 h-4" viewBox="0 0 24 24">
      <path fill="#DD0000" d="M12 2C6.477 2 2 6.477 2 12s4.477 10 10 10 10-4.477 10-10S17.523 2 12 2z"/>
      <path fill="#FFE066" d="M12 7l-3 5h2v5h2v-5h2l-3-5z"/>
    </svg>
  );
}
